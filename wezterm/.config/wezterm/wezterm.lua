...
-- local workspace_saver = require("wezterm-session-manager/wezterm_workspace_saver")
-- local workspace_saver = require("wezterm-session-manager/")
-- local session_manager = require("session-manager")
local session_manager = require("wezterm-session-manager/session-manager")

wezterm.on("save_state", function(window)
	workspace_saver.save_state(window)
end)
wezterm.on("load_state", function()
	workspace_saver.load_state()
end)
wezterm.on("restore_state", function(window)
	workspace_saver.restore_state(window)
end)
